...
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (1, 'multi_choice', '説明文を読むときに、筆者の主張（意見）を見つけるための手がかりとして最も適切なものはどれですか？', '["文章のタイトルだけ","登場人物の会話文","「〜である」「〜と考える」などの表現"]', '「〜である」「〜と考える」などの表現', '説明文では、「〜である」「〜と考える」「〜べきだ」などの表現が、筆者の意見・主張を示すサインです。事実の説明と区別して読むことが重要です。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (1, 'multi_choice', '次の接続語のうち、前の内容を「理由・根拠」として示すときに使われるものはどれですか？', '["なぜなら","つまり","しかし"]', 'なぜなら', '「なぜなら」は直前の内容の理由や根拠を述べるときに使う接続語です。「しかし」は逆接、「つまり」は言い換え・まとめ、「たとえば」は具体例を示すときに使います。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (1, 'multi_choice', '説明文の「結論」の段落にあたるものはどれですか？', '["話題を初めて紹介する段落","具体的な例が多く書かれた段落","筆者の主張やまとめが書かれた段落"]', '筆者の主張やまとめが書かれた段落', '説明文は「序論（導入）→本論（説明・根拠）→結論（まとめ・主張）」の三段構成が基本です。結論には筆者が最も伝えたいことが書かれていることが多いです。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (1, 'multi_choice', '説明文において、同じ言葉や表現が文章中に繰り返し出てくるとき、その言葉を何と呼びますか？（漢字3文字で答えてください）', '["中心語句","反復語句","キーワード"]', 'キーワード', '繰り返し登場する言葉を「キーワード（重要語）」と言います。筆者がとくに伝えたい概念や主張に関わる言葉であることが多く、内容を理解する手がかりになります。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (1, 'multi_choice', '次の文の（　）に入る接続語を答えてください。
「この地域では年間を通じて雨が多い。（　）、植物が豊かに育つ。」', '["しかし","したがって","つまり"]', 'したがって', '「したがって」は前の内容を原因・根拠として、結果や結論を導く接続語（順接）です。「雨が多い→植物が豊かに育つ」という因果関係を表しています。「そのため」「ゆえに」も正解として認められます。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (1, 'multi_choice', 'ある説明文は全部で15段落あります。序論が2段落、結論が3段落のとき、本論は何段落ですか？', '["10","13","5"]', '10', '本論の段落数＝全体の段落数－序論－結論　で求められます。15－2－3＝10段落です。説明文では本論が最も多くの段落を占め、具体的な説明や根拠が展開されます。', 2);
...
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (2, 'multi_choice', '物語文を読むとき、登場人物の気持ちを読み取るヒントとして**適切でないもの**はどれですか？', '["物語が書かれた年代を調べる","登場人物のセリフや言葉づかいに注目する","登場人物の行動や様子を手がかりにする"]', '物語が書かれた年代を調べる', '登場人物の気持ちを読み取るには、セリフ・行動・情景描写などが有効な手がかりです。物語が書かれた年代は背景知識として役立つ場合もありますが、気持ちを直接読み取るヒントにはなりません。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (2, 'multi_choice', '次のうち、物語の「場面が変わった」ことを示すサインとして最も適切なものはどれですか？', '["登場人物の名前が漢字で書かれている","文章が長くなっている","時間・場所・登場人物が変わっている"]', '時間・場所・登場人物が変わっている', '場面の転換は「時間」「場所」「登場人物」の変化によって判断します。これらが変わったとき、物語の場面が切り替わったと読み取ることができます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (2, 'multi_choice', '物語文における「主題（テーマ）」の説明として最も正しいものはどれですか？', '["作者が物語を通して読者に伝えたいこと","登場人物の名前と特徴をまとめたもの","物語の中で一番長い場面のこと"]', '作者が物語を通して読者に伝えたいこと', '主題（テーマ）とは、作者が物語全体を通して読者に伝えようとしているメッセージや考えのことです。登場人物の変化や物語の結末に注目すると読み取りやすくなります。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (2, 'multi_choice', '次の文章を読んで、太郎の気持ちを表す言葉を本文中から抜き出しなさい。

「運動会の徒競走でビリになった太郎は、家に帰っても夕飯を食べずに自分の部屋にこもり、枕に顔を埋めた。」', '["悔しい（くやしい）／悲しい","悩しい（なやましい）","寂しい（さびしい）"]', '悔しい（くやしい）／悲しい', '太郎は徒競走でビリになり、夕飯も食べずに部屋にこもって枕に顔を埋めています。この行動描写から、太郎が「悔しい」「悲しい」気持ちであることが読み取れます。直接「悔しい」という言葉はありませんが、行動から心情を推測することが物語読解の重要なスキルです。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (2, 'multi_choice', '物語文で「情景描写」が使われる目的を、「登場人物の」という書き出しで簡潔に答えなさい。', '["登場人物の特徴を読者に伝えるため","登場人物の行動を説明するため","登場人物の気持ち（心情）を表すため"]', '登場人物の気持ち（心情）を表すため', '情景描写（天気・季節・風景など）は、単に場面の背景を説明するだけでなく、登場人物の心情を間接的に表す役割があります。例えば、悲しい場面での雨の描写や、希望に満ちた場面での晴れの描写などがその典型例です。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (2, 'multi_choice', 'ある物語文は全部で5つの場面で構成されています。先生が「それぞれの場面につき2つずつ、登場人物の気持ちを表す表現を見つけなさい」という課題を出しました。クラス全員（30人）がこの課題をこなすと、クラス全体で見つけた表現は合計何個になりますか？', '["150","300","60"]', '300', '1つの場面につき2つの表現を見つけるので、1人あたり「5場面 × 2個 = 10個」の表現を見つけます。クラス全員（30人）分を合計すると「10個 × 30人 = 300個」になります。', 2);
...
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次のうち、負の数はどれですか？', '["0","−7","+3"]', '−7', '負の数は0より小さい数です。−7は0より小さいので負の数です。+3と5は正の数、0は正でも負でもありません。', 1);
...
　−4、+2、−1、+5', '["+5","+2","−1"]', '−1', '数直線上で右にあるほど大きい数です。小さい順に並べると −4 < −1 < +2 < +5 となります。2番目に小さいのは −1 です。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '|−8| の値として正しいものはどれですか？', '["8","0","−8"]', '8', '絶対値とは数直線上で0からの距離です。−8は0から8だけ離れているので、|−8| = 8 です。絶対値は必ず0以上になります。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次の□にあてはまる不等号（＞または＜）を答えなさい。
　−3 □ −6', '["=",">","<"]', '>', '数直線上で−3は−6より右にあります。右にある数の方が大きいので、−3 > −6 です。負の数は絶対値が大きいほど小さくなることに注意しましょう。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次の計算をしなさい。
　(−4) + (−9)', '["-5","13","-13"]', '-13', '同符号（どちらも負）の数の和は、絶対値の和に共通の符号（−）をつけます。4 + 9 = 13 なので、答えは −13 です。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次の計算をしなさい。
　(+7) + (−10)', '["+3","-17","-3"]', '-3', '異符号の数の和は、絶対値の差に絶対値が大きい方の符号をつけます。絶対値は7と10で差は3。絶対値が大きいのは10（負）なので、答えは −3 です。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次の計算をしなさい。
　(−5) − (−3)', '["-2","2","-8"]', '-2', '引き算は、引く数の符号を変えて足し算にします。(−5) − (−3) = (−5) + (+3) となります。異符号の和なので、絶対値の差 5 − 3 = 2 に絶対値が大きい方の符号（−）をつけて −2 です。', 3);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次の計算をしなさい。
　(−3) × (−4)', '["7","-12","12"]', '12', '負の数どうしの積（かけ算）は正の数になります。符号：(−) × (−) = (+)、絶対値：3 × 4 = 12 なので、答えは +12 = 12 です。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (3, 'multi_choice', '次の計算をしなさい。
　(−18) ÷ (+6)', '["-3","3","-12"]', '-3', '異符号の数の商（割り算）は負の数になります。符号：(−) ÷ (+) = (−)、絶対値：18 ÷ 6 = 3 なので、答えは −3 です。', 2);
...
　(−2)³', '["−8","6","8"]', '−8', '(−2)³ = (−2) × (−2) × (−2) です。まず (−2) × (−2) = +4、次に (+4) × (−2) = −8 となります。負の数の奇数乗は負になります。', 3);
...
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', 'アルファベットの母音（vowel）はどれですか？', '["A・I・U・E・O","A・B・C・D・E","A・E・I・O・U"]', 'A・E・I・O・U', '英語の母音はA・E・I・O・Uの5文字です。日本語の「ア・イ・ウ・エ・オ」とは並び順が異なる点に注意しましょう。残りの21文字はすべて子音（consonant）と呼ばれます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', '次のうち、大文字と小文字の組み合わせが正しいものはどれですか？', '["G と g","D と b","G と q"]', 'G と g', '大文字Gの小文字はgです。bとdは形が似ており混同しやすく、pとqも左右反転の関係にあるため注意が必要です。それぞれ丁寧に形を確認して覚えましょう。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', '次の文の中で、大文字の使い方が正しい文はどれですか？', '["i am ken.","I am ken.","I am Ken."]', 'I am Ken.', '英語では①文の最初の文字、②人名・地名、③「I（私）」は必ず大文字で書きます。「I am Ken.」はすべてのルールが守られており正しい文です。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', 'アルファベットのBの「文字の名前（読み方）」として正しいものはどれですか？', '["ビー","ベ","ブ"]', 'ビー', 'アルファベットBの名前の読み方は「ビー（bee）」です。単語の中での音は「ブ」という音になります（例：ball）。文字の名前と実際の音は異なる場合があるので注意しましょう。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', '「リンゴ」を意味する英単語 apple の最初の文字を大文字で書いてください。', '["P","A","E"]', 'A', 'appleの最初の文字はaで、その大文字はAです。aは母音の1つです。文の最初に来るときや固有名詞では大文字を使いますが、apple自体は一般名詞なので通常は小文字で書きます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', '次のアルファベットを正しいアルファベット順に並べてください。「E・C・A・D・B」', '["A・B・C・D・E","A・B・D・C・E","A・C・B・D・E"]', 'A・B・C・D・E', 'アルファベット順はA→B→C→D→E→F…の順番です。英語の辞書や索引はこの順番に並んでいます。26文字すべての順番を確実に覚えることが英語学習の基礎となります。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', '英語で「私は田中花子です。」と書くとき、( ) に入る適切な語を答えてください。
「( ) am Hanako Tanaka.」', '["i","I","My"]', 'I', '英語で「私」を表す語はIです。Iは単独で使うときは必ず大文字で書きます。文の途中に来ても小文字にしないことが英語のルールです。これはアルファベットの大文字使用の重要なルールの一つです。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (6, 'multi_choice', 'アルファベット26文字のうち、母音（A・E・I・O・U）を除いた子音は何文字ありますか？', '["20","21","22"]', '21', 'アルファベットは全部で26文字あります。そのうち母音はA・E・I・O・Uの5文字です。26－5＝21文字が子音となります。子音の例：B・C・D・F・G・H・J・K・L・M・N・P・Q・R・S・T・V・W・X・Y・Z', 2);
...
「She (　) my friend.」', '["am","is","are"]', 'is', '主語が「She（彼女）」のとき、be動詞は「is」を使います。am はI、are はYou・複数形に使います。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '次の文の（　）に入る正しいbe動詞を選びなさい。
「We (　) students.」', '["is","are","am"]', 'are', '主語が「We（私たちは）」のとき、be動詞は「are」を使います。複数の主語やYouにはareを使います。', 1);
...
「Is he a teacher?」', '["彼は先生ですか？","彼は先生ではありません。","彼は先生です。"]', '彼は先生ですか？', 'be動詞（Is）が文頭に来ているので疑問文です。主語が「he（彼）」なので「彼は先生ですか？」が正解です。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '「I am not hungry.」の短縮形として正しいものを選びなさい。', '["I aren''t hungry.","I isn''t hungry.","I''m not hungry."]', 'I''m not hungry.', '「I am」の短縮形は「I''m」（アポストロフィを忘れずに）です。「am not」はamnʼtとは短縮しないため、I''m notと表します。', 2);
...
「They are busy.」の否定文', '["They not are busy.","They are not busy.","They do not busy."]', 'They are not busy.', 'be動詞の否定文は「be動詞＋not」の語順です。be動詞の前にnotを置いたり、do not を使うのは誤りです。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '次の日本語を英語にしなさい。
「私はケンジです。」
（ローマ字表記：Kenji）', '["I are Kenji.","I is Kenji.","I am Kenji."]', 'I am Kenji.', '「私は」→「I」、be動詞はIに対して「am」、「ケンジです」→「Kenji」を続けます。文末はピリオドを忘れずに。短縮形「I''m Kenji.」も正解です。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '次の文を疑問文に書き換えなさい。
「You are from Japan.」', '["Are you from Japan?","Are you from Japan.","Do you from Japan?"]', 'Are you from Japan?', 'be動詞の疑問文はbe動詞を文頭に移動します。「You are」→「Are you」とし、文末はクエスチョンマーク（?）にします。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '次の疑問文に対して、否定の短い答え方（短縮形を使って）を書きなさい。
「Is she a doctor?」', '["No, he isn''t.","No, she isn''t.","No, she doesn''t."]', 'No, she isn''t.', 'Is she ～? への否定の答えは「No, she is not.」または短縮形「No, she isn''t.」です。主語をsheで受け答えることがポイントです。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '次の（　）に適切な語を入れて、会話を完成させなさい。
A: Are you happy?
B: Yes, I (　).', '["is","am","are"]', 'am', 'Are you ～? への肯定の答えは「Yes, I am.」です。疑問文のbe動詞がareでも、答えるときは主語Iに合わせてamを使います。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (7, 'multi_choice', '次の5つの文のうち、be動詞の使い方が正しい文はいくつありますか？数字で答えなさい。

① I am a student.
② She are kind.
③ We is friends.
④ He is my brother.
⑤ You are tall.', '["2","3","4"]', '3', '①「I am」→ 正しい。②「She are」→ 誤り（She is が正しい）。③「We is」→ 誤り（We are が正しい）。④「He is」→ 正しい。⑤「You are」→ 正しい。よって正しい文は①④⑤の3つです。', 3);
...
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (10, 'multi_choice', '葉の気孔について正しい説明はどれですか？', '["2つの孔辺細胞に囲まれており、水蒸気や気体の出入り口になっている","光合成を直接行う場所であり、葉緑体は含まない","葉の表側にのみ存在し、常に開いている"]', '2つの孔辺細胞に囲まれており、水蒸気や気体の出入り口になっている', '気孔は2つの孔辺細胞に囲まれた隙間で、蒸散（水蒸気の放出）や光合成・呼吸に必要な気体（CO₂・O₂）の出入り口です。気孔は主に葉の裏側に多く存在し、孔辺細胞が膨らむと開き、しぼむと閉じます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (10, 'multi_choice', '維管束の「道管」が運ぶものはどれですか？', '["光合成で作られた糖","水と無機塩類","酸素と二酸化炭素"]', '水と無機塩類', '道管は根から吸収した水と無機塩類（ミネラル）を葉などの上方へ運びます。一方、師管は葉の光合成で作られた糖などの有機物を植物全体に運びます。道管と師管をまとめて「維管束」といいます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (10, 'multi_choice', '双子葉類と単子葉類の茎の違いとして正しいものはどれですか？', '["双子葉類の維管束は輪状に並び、単子葉類の維管束は散在する","どちらも維管束は輪状に並ぶが、道管と師管の位置が逆である","単子葉類の維管束は輪状に並び、双子葉類の維管束は散在する"]', '双子葉類の維管束は輪状に並び、単子葉類の維管束は散在する', '茎の断面を観察すると、アブラナやホウセンカなどの双子葉類は維管束が輪のように規則正しく並んでいます。トウモロコシやイネなどの単子葉類は維管束が茎全体に不規則に散らばっています。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (10, 'multi_choice', '光合成の反応に必要な材料（原料）を2つ答えてください。', '["水と二酸化炭素","水と酸素","光と二酸化炭素"]', '水と二酸化炭素', '光合成は「水＋二酸化炭素 →（光エネルギー・葉緑体）→ デンプン（有機物）＋酸素」という反応です。水は根から道管を通じて運ばれ、二酸化炭素は気孔から取り込まれます。光エネルギーは材料ではなくエネルギー源です。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (10, 'multi_choice', '根の先端付近にある、水の吸収面積を大きくするための構造を何といいますか？', '["気孔","根毛","根端"]', '根毛', '根毛は根の表皮細胞が細長く伸びた毛のような構造です。根毛があることで表面積が非常に大きくなり、土の中の水や無機塩類を効率よく吸収できます。根毛は根の先端から少し上の部分（成長点の上）に密生しています。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (10, 'multi_choice', 'ある植物の葉1枚の気孔の数を調べると、表側に1cm²あたり100個、裏側に1cm²あたり400個ありました。この葉の片面の面積が10cm²のとき、葉1枚の気孔の合計数は何個ですか？', '["5000","10000","4000"]', '5000', '表側の気孔数：100個/cm² × 10cm² ＝ 1000個。裏側の気孔数：400個/cm² × 10cm² ＝ 4000個。合計：1000＋4000＝5000個。このように、多くの植物では気孔は葉の裏側に圧倒的に多く存在します。これは表側に気孔が多いと水分が蒸発しすぎるためと考えられています。', 3);
...
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '世界で最も面積が大きい大陸はどれですか？', '["アフリカ大陸","ユーラシア大陸","北アメリカ大陸"]', 'ユーラシア大陸', 'ユーラシア大陸はアジアとヨーロッパを合わせた大陸で、六大陸の中で最も面積が大きい大陸です。面積は約5,500万km²で、陸地全体の約37%を占めています。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '本初子午線（経度0°）が通るイギリスの都市はどれですか？', '["エジンバラ","ロンドン","マンチェスター"]', 'ロンドン', '本初子午線はイギリスのロンドンにある旧グリニッジ天文台を通る経線で、経度の基準（0°）となっています。この線を基準に東側を東経、西側を西経と呼びます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '地球の表面における海洋の割合として最も近いものはどれですか？', '["約50%","約70%","約30%"]', '約70%', '地球の表面積の約70%は海洋（水）で覆われており、残りの約30%が陸地です。そのため地球は「水の惑星」とも呼ばれます。', 1);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '赤道を0°として、南北それぞれ90°に分けた地球上の位置を表す角度のことを何といいますか？', '["経度","標高","緯度"]', '緯度', '緯度は赤道を基準（0°）として、北極点を北緯90°、南極点を南緯90°とする角度です。同じ緯度を結んだ線を緯線といい、赤道に平行に引かれます。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '太平洋・大西洋と並ぶ三大洋のひとつで、アフリカ大陸・アジア大陸・オーストラリア大陸に囲まれた海洋の名前を答えなさい。', '["インド洋","南極海","北極海"]', 'インド洋', 'インド洋は三大洋のひとつで、太平洋・大西洋に次いで3番目に大きい海洋です。アフリカ大陸・アジア大陸・オーストラリア大陸・南極大陸に囲まれています。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '経度が15°異なると1時間の時差が生じます。日本（東経135°）とイギリス・ロンドン（経度0°）の時差は何時間ですか？', '["9","10","8"]', '9', '時差は「経度の差 ÷ 15°」で求められます。日本の標準時子午線は東経135°、ロンドンは経度0°なので、経度の差は135°です。135° ÷ 15° = 9 となり、時差は9時間です。日本はロンドンより9時間進んでいます。', 2);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '次の大陸のうち、ほぼ全域が南半球に位置するものはどれですか？', '["オーストラリア大陸","ユーラシア大陸","北アメリカ大陸"]', 'オーストラリア大陸', 'オーストラリア大陸はほぼ全体が南半球（赤道より南）に位置しています。アフリカ大陸は赤道をまたいで南北半球にまたがっており、ユーラシア大陸・北アメリカ大陸は主に北半球に位置します。', 3);
INSERT INTO questions (topic_id, type, question_text, choices, answer, explanation, difficulty) VALUES (12, 'multi_choice', '赤道の全周は約40000kmです。赤道上で経度1°あたりの距離は約何kmになりますか？整数で答えなさい。', '["111","222","400"]', '111', '赤道は360°で全周約40000kmなので、1°あたりの距離は 40000 ÷ 360 ≒ 111.1…km となります。よって約111kmです。この計算から、緯度・経度1°の差がどれくらいの距離に相当するかがわかります。', 3);
